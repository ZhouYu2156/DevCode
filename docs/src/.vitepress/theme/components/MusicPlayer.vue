...
import PlayingMusicController from '../components/PlayingMusicController.vue'
import PauseMusicController from '../components/PauseMusicController.vue'
...
<template>
    <div class="playMusic-wrapper">
        ...
        <audio ref="audio" preload="auto" :autoplay="isPlayed" :src="currentMusic" style="display: none;"
            controls></audio>
    </div>
</template>
